...
//         return $bcrypt->verify($passwordGiven, $user->getLozinka());
		//posto u bazi nisu kriptovane lozinke, pravim svoju provjeru sa otvorenim lozinkama
    	$valid = new \Zend\Validator\Identical($passwordGiven);
    	if ($valid->isValid($user->getLozinka())) {
    		return true;
    	}
    	else { return false; }
    }
